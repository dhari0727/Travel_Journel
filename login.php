...
$evalue = "";
$email=$_POST['eml'];
$qu = "SELECT * FROM signup WHERE eml='$email' ";
...
if($ttl == 1){
$_SESSION['fname']=$res1['fname'];
$_SESSION['lname']=$res1['lname'];
$_SESSION['eml']=$res1['eml'];
}
else{
...
if(isset($_POST['lgn'])){
    ...
    $query = "SELECT * FROM signup WHERE eml='$email' && psw='$password'" ;
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li class="mobile-wishlist"><b><h3>Welcome to Travel Journel</b></h3></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                        ...
                        <form class="theme-form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name = "password" id="review"
                                    placeholder="Enter your password" required><span style="color: red;"><?php echo $evalue; ?></span><br>

                            </div><input type="Submit" name = "lgn" value="Login" class="btn btn-solid"> 
                ...
                <div class="col-lg-6 right-login" data-animate="fade-up">
                    ...
                    <div class="theme-card authentication-right">
                        ...
                        <p>Are you ready to document your travel tales and create lasting memories? Welcome to Travel Journal, your gateway to capturing the essence of your journeys. Signing up is a breeze, and it's the first step towards preserving your adventures.<br><br></p><a href="register.php"
