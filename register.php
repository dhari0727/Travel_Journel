...
if (isset($_POST["sn"])) {
    ...
    $check_sql = "SELECT * FROM signup WHERE eml = '$eml'";
    $check_result = mysqli_query($conn, $check_sql);
    $uppercase = preg_match('@[A-Z]@', $psw);
    $lowercase = preg_match('@[a-z]@', $psw);
    $number = preg_match('@[0-9]@', $psw);
    $specialChars = preg_match('/[!@#$%^&*()\-_=+{};:,<.>]/', $psw);
    $minLength = strlen($psw) >= 8 || ($uppercase && $lowercase && $number && $specialChars);
    $validate = filter_var($eml, FILTER_VALIDATE_EMAIL);

    if (mysqli_num_rows($check_result) > 0) {
        $err2 = "Email already exists!";
    } else if (!$minLength) {
        $err = "Password must contain at least 8 characters, 1 special character, and 1 capital letter!";
    } else if (!$validate) {
        $err2 = "Please enter a valid email!";
    } else {
        $sql = "INSERT INTO signup (fname, lname, eml, psw) VALUES ('$fname', '$lname', '$eml', '$psw')";
        ...
        if ($result) {
            ...
            exit(); // Important: Ensure script execution stops after redirection
        }
    }
}
?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>Welcome to Travel Journel</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <form method="POST" class="theme-form">
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="fname" id="fname" placeholder="First Name" value="<?php echo isset($fname) ? $fname : ''; ?>"
                                        required >
                                </div>
                                <div class="col-md-6">
                                    <label for="review">LastName</label>
                                    <input type="text" class="form-control" name="lname" id="lname" placeholder="Last Name"  value="<?php echo isset($lname) ? $lname : ''; ?>"
                                        required >
                                </div>
                            </div>
                            <div class="form-row">
                        <div class="col-md-6">
                            <label for="email">Email</label><span style="color:red;"><?php echo $err2; ?></span>
                            <input type="text" class="form-control" name="eml" id="email" placeholder="Email"  value="<?php echo isset($eml) ? $eml : ''; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="password">Password</label>
                            <input type="password" class="form-control" name="psw" id="password" placeholder="Password"  required=""><span style="color:red;"><?php echo $err; ?></span>
                        </div>
                        <div class="col-md-12">
                            <input type="submit" name="sn" value="Sign Up" class="btn btn-solid">
                        </div>
                    </div>                        
                </form>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-title footer-mobile-title">
                            <h4>about</h4>
                               ...
                               <img src="p1/pt.png" alt="Image Description">
                            ...
                            <div class="set-position">
                                ...
                                <div class="demo-text">
                                    ...
                                    <div class="btn-group demo-btn" role="group" aria-label="Basic example"> <button
                                            type="button" onClick="window.open('login.php')"
