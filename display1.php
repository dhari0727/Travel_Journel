    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-11 col-md-12">
                ...
                <?php if ($res1 = mysqli_fetch_assoc($d1)) { ?>
                ...
                <div class="tj-section">
                    ...
                    <div class="tj-expense-card"><span>Breakfast</span><span>₹ <?php echo $res1['break']; ?></span></div>
                    <div class="tj-expense-card"><span>Lunch</span><span>₹ <?php echo $res1['lunch']; ?></span></div>
                    <div class="tj-expense-card"><span>Snacks</span><span>₹ <?php echo $res1['snacks']; ?></span></div>
                    <div class="tj-expense-card"><span>Dinner</span><span>₹ <?php echo $res1['dinner']; ?></span></div>
                    <div class="tj-expense-card"><span>Beverages</span><span>₹ <?php echo $res1['beverages']; ?></span></div>

                    <div class="tj-expense-total">
                        <span>Food Total</span>
                        <span>₹ <?php echo $res1['FOOD_COST']; ?></span>
                    </div>
                </div>
                ...
                <div class="tj-section">
                    ...
                    <div class="tj-expense-card"><span>Car Hiring</span><span>₹ <?php echo $res1['car']; ?></span></div>
                    <div class="tj-expense-card"><span>Taxi Fare</span><span>₹ <?php echo $res1['taxi']; ?></span></div>
                    <div class="tj-expense-card"><span>Train Ticket</span><span>₹ <?php echo $res1['train']; ?></span></div>
                    <div class="tj-expense-card"><span>Flight Fare</span><span>₹ <?php echo $res1['flight']; ?></span></div>
                    <div class="tj-expense-card"><span>Underground</span><span>₹ <?php echo $res1['underground']; ?></span></div>
                    <div class="tj-expense-card"><span>Pass</span><span>₹ <?php echo $res1['pass']; ?></span></div>
                    <div class="tj-expense-card"><span>Others</span><span>₹ <?php echo $res1['others']; ?></span></div>

                    <div class="tj-expense-total">
                        <span>Transport Total</span>
                        <span>₹ <?php echo $res1['TRANSPORT_COST']; ?></span>
                    </div>
                </div>
                ...
                <div class="tj-pagination">
                    ...
                    <a class="btn btn-primary"
                       href="display2.php?title=<?php echo urlencode($_GET['title']); ?>&date=<?php echo urlencode($_GET['date']); ?>&email=<?php echo urlencode($_GET['email']); ?>">
                        Next →
                    </a>
                </div>
